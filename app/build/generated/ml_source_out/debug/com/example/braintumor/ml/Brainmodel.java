package com.example.braintumor.ml;
...
public final class Brainmodel {
  ...
  private Brainmodel(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "brainmodel.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static Brainmodel newInstance(@NonNull Context context) throws IOException {
    return new Brainmodel(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static Brainmodel newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new Brainmodel(context, options);
  }
